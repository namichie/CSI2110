...
public class LetterFrequencies {
	...
	static int NUM_CHARS = '\uffff' + 1; // there are 2^16 possible characters
											// in UTF-16
	...
	public LetterFrequencies(String inputText) {
		...
		for (int i = 0; i < inputText.length(); i++) {
			if (counter[(int) inputText.charAt(i)] == 0)
				lettersThatShowUp.add(inputText.charAt(i));
